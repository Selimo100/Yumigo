    ...
    try {
        ...
        try {
            ...
            if (userDocSnap.exists()) {
                ...
                // WICHTIG: Stelle sicher, dass 'username' in deinem User-Dokument vorhanden ist (siehe Screenshot users/uid)
        ...
        const docRef = await addDoc(collection(db, 'recipes'), {
            ...
            authorName: authorName, // <-- DIESE ZEILE IST ENTSCHEIDEND!
