// Firebase Config - Firebase-Initialisierung und Konfiguration für Auth, Firestore und Storage
...
export const saveRecipe = async (recipeData) => {
    try {
        ...
        if (!currentUser) {
            throw new Error("Authentication required. Please log in to save a recipe.");
        }

        let authorName = 'Unbekannt';
